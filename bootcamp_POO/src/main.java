...
public class main {
    public static void main(String[] args) {
        ...
        Dev devIlisio = new Dev();
        devIlisio.setNome("Ilisio");
        devIlisio.inscreverBootcamp(bootcamp);
        System.out.println("Conteúdos Inscritos Ilisio:" + devIlisio.getConteudosInseridos());
        ...
        System.out.println("Conteúdos Inscritos Ilisio:" + devIlisio.getConteudosInseridos());
        System.out.println("Conteúdos Concluidos Ilisio:" + devIlisio.getConteudosConcluidos());
